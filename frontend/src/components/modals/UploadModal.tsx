      ...
      >
        ...
        <div className="p-4 space-y-4">
          ...
          {isImage && previewUrl ? (
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-8 border border-gray-200 dark:border-gray-600 flex flex-col items-center justify-center">
              <File className="w-16 h-16 text-gray-400 dark:text-gray-500 mb-2" />
              <p className="text-sm text-gray-600 dark:text-gray-400">{file.type || 'Unknown type'}</p>
            </div>
          )}
